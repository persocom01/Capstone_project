...
search_term = '#RickyGervais'
search_term = search_term.lower()
project_folder = 'data'

# Get tweet from hastag. Twitter api tweet limit should be 2500 per 15 min.
# max_tweets = 2500
tweepy_object = tweepy.Cursor(api.search, q=search_term, rpp=100).items()
